					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								...
								<li><a href=""><i class="fa fa-envelope"></i> HT-Store@gmail.com</a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="col-sm-4">
					<div class="signup-form"><!--sign up form-->
						...
						<form action="#">
							...
							<input class="form-control form-control-sm" type="text" name="zip" placeholder="Zip / Postal Code" required />
